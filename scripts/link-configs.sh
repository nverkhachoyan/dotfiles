...
link_path "$repo_root/config/ghostty/font.conf" "$HOME/.config/ghostty/font.conf"
link_path "$repo_root/config/ghostty/theme.conf" "$HOME/.config/ghostty/theme.conf"
link_path "$repo_root/config/ghostty/window.conf" "$HOME/.config/ghostty/window.conf"
...
link_path "$repo_root/shims/.bash_profile" "$HOME/.bash_profile"
link_path "$repo_root/shims/.bashrc" "$HOME/.bashrc"
link_path "$repo_root/shims/.profile" "$HOME/.profile"
link_path "$repo_root/shims/.zshenv" "$HOME/.zshenv"
